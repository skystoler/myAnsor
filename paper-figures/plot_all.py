...
if __name__ == "__main__":
    ...
    run_cmd('python3 plot_op_subgraph_eval.py --device "Intel-E5-2650-v4-2.20GHz" --mode op --out-file figure_6.%s' % args.format)
    run_cmd('python3 plot_op_subgraph_eval.py --mode subgraph --out-file figure_8.%s' % args.format)

    # network eval
    run_cmd('python3 plot_network_eval.py --device "Intel-E5-2650-v4-2.20GHz" --batch-size 16 --out-file figure_9_a.%s' % args.format)
