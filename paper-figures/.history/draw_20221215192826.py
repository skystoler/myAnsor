...
if __name__ == "__main__":
    ...
    ax.set_ylabel("Relative Speedup", fontsize=18)
    #ax.text(1.10, -0.15, '# Measurement trials', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes, fontsize=ax.yaxis.label.get_size())
    ax.text(1.10, -0.15, 'Iterations','center','center',fontsize=18)
    ax.legend(name_list,
            fontsize=18,
            loc='upper center',
