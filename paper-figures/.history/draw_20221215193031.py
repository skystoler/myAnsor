...
if __name__ == "__main__":
    ...
    ax.text(0.5, -0.15, 'Iterations', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes, fontsize=ax.yaxis.label.get_size())
    #ax.text(1.10, -0.15, 'Iterations',fontsize=18)
    ax.legend(name_list,
            fontsize=18,
            loc='upper center',
            bbox_to_anchor=(1, 1.27),
            ncol=3,
            handlelength=1.0,
            handletextpad=0.5,
            columnspacing=1.1)
