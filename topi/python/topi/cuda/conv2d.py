...
def conv2d_nhwc_winograd_cuda(input, weight, strides, padding, dilation, out_dtype,
        pre_computed=False, ansor_kernel_layout=""):
    tile_size = _infer_tile_size(input, weight)
    return _conv2d_nhwc_winograd_impl(input, weight, strides, padding, dilation, out_dtype,
            tile_size, pre_computed, ansor_kernel_layout)
