...
wkl_list = [
    ...
    Workload("network", "resnet-50", resnet50),
    Workload("network", "mobilenet-v2", mobilenet_v2),
    Workload("network", "resnet3d-18", resnet3d_18),
    ...
    for wkl in wkl_list:
        for batch_size in batch_size_list:
            ...
            if wkl.workload_type == 'op' or wkl.workload_type == 'subgraph':
                ...
                log_line(BenchmarkRecord(args.backend, args.backend, wkl.workload_type, workload_name,
                                         "pytorch", algorithm, {"costs": [cost]}, time.time()),
                                         args.out_file)
            else:
